...
<head>
	...
	<meta name="revised" content="Tuesday, March 19th, 2024, 20:20" />
	<meta name="Classification" content="Education">
	<meta name="url" content="https://smkn1mandiraja.sch.id">
	<meta name="identifier-URL" content="https://smkn1mandiraja.sch.id">
	...
	<?= link_tag('views/themes/lumen/style.css') ?>
...
<body>
	...
	<header>
		<div class="container-fluid menu-bar">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-12">
						<ul class="list-inline text-center mb-0 p-1" style="color:#fff;background:#00B0F0;font-size:12px;">
							...
							<li class="list-inline-item pl-3 pr-0"><a href="<?= site_url('feed') ?>" style="color:#fff;"><i class="fa fa-rss"></i> RSS</a></li>
							<li class="list-inline-item pl-3 pr-0"><a href="#search_form" style="color:#fff;"><i class="fa fa-search"></i> Pencarian</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="container-fluid top-bar">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="d-none d-md-block col-md-7 col-sm-12 col-xs-12 text-right">
						<div class="top-left">
							<img src="<?= base_url('assets/img/perbankan.png') ?>" width="70" height="70" class="mt-2 mb-3">
							<img src="<?= base_url('assets/img/teknikpemesinan.png') ?>" width="70" height="70" class="mt-2 mb-3">
							<img src="<?= base_url('assets/img/teknikgambarbangunan.png') ?>" width="70" height="70" class="mt-2 mb-3">
							<img src="<?= base_url('assets/img/alatmesinpertanian.png') ?>" width="70" height="70" class="mt-2 mb-3">
						</div>
					</div>
				</div>
			</div>
		...
		<!--  NAVIGATION MENU -->
		<div class="container-fluid menu-bar mb-3" data-toggle="sticky-menu" style="border-bottom: 5px solid #fff000;">
			<div class="container">
			...
			<div class="container copyright">
				<div class="row pt-1 pb-1">
					<div class="col-md-12 col-xs-12 text-center">
						<?= copyright(2024, base_url(), __session('school_name')) ?>
					</div>
				</div>
			</div>
		</div>
